...
{
    public partial class db_saralContext : DbContext
    {
        public db_saralContext()
        {
        }

        public db_saralContext(DbContextOptions<db_saralContext> options)
            : base(options)
        {
        }

        public virtual DbSet<AttDefinition> AttDefinition { get; set; }
        public virtual DbSet<AttEncash> AttEncash { get; set; }
        public virtual DbSet<LevAdjustment> LevAdjustment { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=192.168.0.252;User Id=usr_saral; Password=saral@909!@#;Initial Catalog=db_saral;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AttDefinition>(entity =>
            {
                ...
                entity.Property(e => e.Allotmentyn)
                    .HasColumnName("ALLOTMENTYN")
            ...
            modelBuilder.Entity<AttEncash>(entity =>
            {
                entity.HasKey(e => new { e.Empid, e.Encashslno });

                entity.ToTable("ATT_ENCASH");

                entity.Property(e => e.Empid).HasColumnName("EMPID");

                entity.Property(e => e.Encashslno).HasColumnName("ENCASHSLNO");

                entity.Property(e => e.Addentryid).HasColumnName("ADDENTRYID");

                entity.Property(e => e.Allotid).HasColumnName("ALLOTID");

                entity.Property(e => e.Calcamt)
                    .HasColumnName("CALCAMT")
                    .HasColumnType("numeric(15, 2)");
                ...
                entity.Property(e => e.Mopbank)
                    .HasColumnName("MOPBANK")
                    .HasMaxLength(100);
                ...
                entity.Property(e => e.Onrtnyn)
                    .HasColumnName("ONRTNYN")
                ...
                entity.Property(e => e.Tdspaydate)
                    .HasColumnName("TDSPAYDATE")
                ...
                entity.HasOne(d => d.Allot)
                    .WithMany(p => p.AttEncash)
                    .HasForeignKey(d => d.Allotid)
                    .HasConstraintName("FK_ATT_ENCASH_LEV_ALLOTMENT");

                entity.HasOne(d => d.Emp)
                    .WithMany(p => p.AttEncash)
                    .HasForeignKey(d => d.Empid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ATT_ENCASH_MAS_EMPLOYEE");
            });

            modelBuilder.Entity<LevAdjustment>(entity =>
            {
                entity.HasKey(e => new { e.Empid, e.Empdetid, e.Attheadid, e.Levid, e.Monthyear })
                    .HasName("PK__LEV_ADJU__C41472471BBE003C");

                entity.ToTable("LEV_ADJUSTMENT");
            ...
            modelBuilder.Entity<LevAllotment>(entity =>
            {
                ...
                entity.Property(e => e.Editmodeyn)
                    .HasColumnName("EDITMODEYN")
                    .HasDefaultValueSql("((1))");
            ...
            modelBuilder.Entity<MasEmployee>(entity =>
            {
                ...
                entity.Property(e => e.Emailpwdchgyn)
                    .HasColumnName("EMAILPWDCHGYN")
                    .HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.Intrntnlworkeryn)
                    .HasColumnName("INTRNTNLWORKERYN")
                    .HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.Pfrestrictcmpyn)
                    .HasColumnName("PFRESTRICTCMPYN")
                    .HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.Printaddrsyn)
                    .HasColumnName("PRINTADDRSYN")
                    .HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.Rejempid)
                    .HasColumnName("REJEMPID")
                    .HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.Stateidp)
                    .HasColumnName("STATEIDP")
                    .HasDefaultValueSql("((0))");
