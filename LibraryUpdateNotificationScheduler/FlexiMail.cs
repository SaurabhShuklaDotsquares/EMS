using LibraryUpdateNotificationScheduler;
using System;
...
public class FlexiMail
{
    ...
    public void Send()
    {
        ...
        client.Host = SiteKeys.HostName;
        client.DeliveryMethod = SmtpDeliveryMethod.Network;
        client.Credentials = new NetworkCredential(SiteKeys.SMTPUserName, SiteKeys.SMTPPassword);
        client.Port = Convert.ToInt32(SiteKeys.SMTPPort);
        client.Send(myEmail);
    }
    #endregion
