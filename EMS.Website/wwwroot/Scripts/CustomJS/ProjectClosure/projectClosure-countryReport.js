    ...
    function index() {
        ...
        function loadGrid() {
            ...
            grid = new Global.GridHelper('#grid-projectcloser', {
                ...
                ajax:
                {
                    url: domain + "projectclosure/countryreport",
                    type: "Post",
                    data: function (d) {
                        getfilter(d);
                    }
                ...
                columns:
                    [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row, meta) {
                                var project = "";
                                project += "<div style='font-weight:bold !important; margin: 0;'>" + data + "<div>" +
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                    ...
                    if (aData.isPending) {
                        $(nRow).addClass('darkred_border');
                    }
                    else if (aData.hasConverted) {
                        $(nRow).addClass('hasConverted_border');
                    }
                    else if (!aData.hasReview) {
                        $(nRow).addClass('hasReview_border');
                    }
                },
