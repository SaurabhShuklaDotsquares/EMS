    ...
    function index() {
        ...
        function initGridControlWithEvents() {
            $('.switchBox').on('change', function () {
                ...
                $.get(domain + 'Domain/UpdateStatus', {
                    id: this.value
                });
            });
        }
        ...
        function initializeModalWithForm() {
            $("#modal-add-DomainType").on('loaded.bs.modal', function () {
                var modal = $(this);
        ...
        function loadtaskgrid() {
            ...
            grid = new Global.GridHelper('#grid-DomainList', {
                serverSide: true,
                destroy: true,
                "pageLength": 50,
                "bFilter": true,
                ...
                columns:
                    [
                        { name: "DomainId", data: "domainId", title: "#", sortable: false, searchable: false, visible: false },
                        { name: "rowIndex", data: "rowIndex", title: "#", sortable: false, searchable: false, visible: true },
                        { name: "Title", data: "title", title: "Domain Name", sortable: false, searchable: false, visible: true },
                        {
                            ...
                            render: function (data, type, dataRow, meta) {
                                ...
                                if (dataRow.status == true) {
                                    ...
                                    content = content + '<label class="switch"><input type="checkbox" title="Active" class="switchBox" id="isactive" name="isactive" value="' + dataRow.domainId + '" checked/><span class="slider round"></span></label>';
                                }
                                else {
                                    content = content + '<label class="switch"><input type="checkbox" title="InActive" class="switchBox" id="IsActive" name="IsActive" value="' + dataRow.domainId + '" /><span class="slider round"></span></label>';
                                }
                        ...
                        },
                        {
                            ...
                            render: function (data, type, dataRow, meta) {
                                var actionButtons = $("<a/>", {
                                    id: "editDomain",
                                    title: "edit",
                                    href: domain + "Domain/add/" + data.domainId,
                                    'data-toggle': "modal",
                                    'data-target': "#modal-add-DomainType",
