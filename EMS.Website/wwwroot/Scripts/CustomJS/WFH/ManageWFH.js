    ...
    function ManageWFH() {
                ...
                $("#StartDate").datepicker({
                    ...
                    onClose: function (selectedDate) {
                        ...
                        if ($('#IsSelfWFH').is(":checked")) {
                            ...
                            $("#EndDate").datepicker("option", "maxDate", 365);
                        }
                    }
                });
                $("#EndDate").datepicker({
        ...
        */
        ...
        function GetUserLeave() {
            ...
            $.post(domain + 'leave/GetUserLeaves', { uid: uId, edit: isEdit }, function (result) {
                var data = result;
        ...
        function ValidateUID() {
            if ($('#IsSelfWFH').length > 0) {
                if ($('#IsSelfWFH').prop('checked')) {
                    $('.dvuser').addClass('hide');
                    $('#Uid').addClass('validated');
                    $('.dvleavestatus').addClass('hide');
                    $('.dvleavestatus input,.dvleavestatus textarea').addClass('validated');
