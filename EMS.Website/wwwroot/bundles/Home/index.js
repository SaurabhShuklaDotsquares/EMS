...
(function ($) {
    ...
    function index() {
        ...
        var $this = this, postSaleActivitygrid, PreSaleActivitygrid, Invoicegrid, taskgrid, homeVM = new HomeViewModel();
                    ...
                    [
                       ...
                       },
                       {
                           ...
                           render: function (data, type, row, meta) {
                               return "<span style=color:#057db2; font-weight:600 !important;> CRM ID: </span> [" + row.crmProjectId + "]" + "<br/>" +
                                   data + "[" + row.pCountry + "]";
                           }
                       },
                       {
                           ...
                           render: function (data, type, row, meta) {
                               return "<span>" + data + "<span>" + "<div style='font-size:11px;'>Generated Date : " + row.createdDate + "</div>" +
        ...
        function loadPreSales() {
            ...
            PreSaleActivitygrid = new Global.GridHelper('#grid-homePreSaleActivity', {
                ...
                columns:
                    [
                       {
                           name: "client", data: "client", title: "Client", sortable: false, searchable: false, visible: true,
                           render: function (data, type, dataRow, meta) {
                               var client = "CRMId : " + (dataRow.crmid != "" ? "<b>" + dataRow.crmid + "</b>" : "N/A") + '</br>';
                               ...
                               return client += "</br>" + dataRow.newClient;
                           }
                       },
                     {
                         ...
                         render: function (data, type, dataRow, meta) {
                             ...
                             title += dataRow.allowConclusionAndEdit ? '<a data-toggle="modal" data-target="#modal-conclusion" style="text-decoration:underline" href="' + domain + 'estimate/Conclusion/' + dataRow.leadId + '">' + dataRow.leadTitle + '</a>' : dataRow.leadTitle;

                             return title += ' ' + (dataRow.remark != "" ? "<a href='javascript:void(0)' class='remarkTitle' title='" + dataRow.remark + "'><img src='" + domain + "images/icons/Comments-icon.png' alt='R' /></a>" : "") + ' [<b>LeadId:' + dataRow.leadId + '</b>]</br><div style="font-size: 11px;">Generated on: ' + dataRow.generatedDate + '</br>Last Activity: ' + dataRow.modifiedDate + ' </br> <a target="_black" style="text-decoration:underline;" href="' + domain + 'upload/estimatedocument/' + dataRow.proposalDocument + '">' + dataRow.proposalDocument + '</a></div>';
                         }
                     },
                       { name: "estimateTime", data: "estimateTimeinDay", title: "ESTIMATED TIME", sortable: false, searchable: false, visible: true },
                       {
                        ...
                        { name: "technologies", data: "technologies", title: "technologies", sortable: false, searchable: false, visible: true },
                        {
                            ...
                            render: function (data, type, dataRow, meta) {
                                return (dataRow.source != "" ? "<b>" + dataRow.source + "</b><br/> Assigned on:</br>" + dataRow.assignedDate : "");
                            }
                        },
                        {
            ...
            taskgrid = new Global.GridHelper('#grid-taskList', {
                ...
                columns:
                    [
                       ...
                       { name: "TaskName", data: "taskName", title: "Task", sortable: false, searchable: false, visible: true },
