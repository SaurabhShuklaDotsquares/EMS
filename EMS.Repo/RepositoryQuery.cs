...
namespace EMS.Repo
{
    public sealed class RepositoryQuery<TEntity> where TEntity : class
    {
        ...
        public IEnumerable<TEntity> GetPageWithoutPaging()
        {
            //_page = page;
            //_pageSize = pageSize;
            //totalCount = _repository.Get(_filter).Count();
        ...
        public IEnumerable<TEntity> GetSaral()
        {
            return _repository.GetSaral(
                _filter,
                _trackingEnabled,
                _orderByQuerable, _includeProperties, _page, _pageSize);
        }
        public IEnumerable<TEntity> GetSaralDT()
        {
            return _repository.GetSaralDT(
                _filter,
                _trackingEnabled,
                _orderByQuerable, _includeProperties, _page, _pageSize);
        }
